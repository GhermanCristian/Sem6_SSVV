...
public class TestAddStudent {
    ...
    @Test
    public void TestAddStudent_StudentGroupTooLarge_ThrowsValidationException() {
        Student newStudent = new Student("1111", "a b", 1000, "aa@yahoo.com");
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_EmptyStudentName_ThrowsValidationException() {
        Student newStudent = new Student("1111", "", 999, "aa@yahoo.com");
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_NullStudentName_ThrowsValidationException() {
        Student newStudent = new Student("1111", null, 999, "aa@yahoo.com");
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_StudentNameContainsIllegalSymbols_ThrowsValidationException() {
        Student newStudent = new Student("1111", "aa11 bb", 999, "aa@yahoo.com");
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_StudentNameIsJustOneWord_ThrowsValidationException() {
        Student newStudent = new Student("1111", "aa", 999, "aa@yahoo.com");
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_EmptyStudentID_ThrowsValidationException() {
        Student newStudent = new Student("", "aa bb", 999, "aa@yahoo.com");
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_NullStudentID_ThrowsValidationException() {
        Student newStudent = new Student(null, "aa bb", 999, "aa@yahoo.com");
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_EmptyStudentEmail_ThrowsValidationException() {
        Student newStudent = new Student("1111", "aa bb", 999, "");
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_NullStudentEmail_ThrowsValidationException() {
        Student newStudent = new Student("1111", "aa bb", 999, null);
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_WrongStudentEmailLocalPart_ThrowsValidationException() {
        Student newStudent = new Student("1111", "aa bb", 999, "@yahoo.com");
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_WrongStudentEmailDomain_ThrowsValidationException() {
        Student newStudent = new Student("1111", "aa bb", 999, "aa@yahoo.con");
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_DigitInStudentEmailDomain_ThrowsValidationException() {
        Student newStudent = new Student("1111", "aa bb", 999, "aa@yahoo1.com");
        assertThrows(ValidationException.class, () -> this.service.addStudent(newStudent));
    }

    @Test
    public void TestAddStudent_NoAtSymbolInStudentEmail_ThrowsValidationException() {
